  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "marquee-left-slow": "marquee-left 90s linear infinite",
        "marquee-right-slow": "marquee-right 90s linear infinite",
        "marquee-left-very-slow": "marquee-left 180s linear infinite",
        "marquee-right-very-slow": "marquee-right 180s linear infinite",
